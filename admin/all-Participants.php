...
<head>
    ...
    <title>All Participants | Admin </title>
...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
								...
								<li><a title="Participants Required Details" href="#"><span class="mini-sub-pro"> Participants <br>Required Details </span></a></li>
    ...
    <div class="all-content-wrapper" >
      ...
      <div class="single-pro-review-area mt-t-30 mg-b-15" id="work-area">
        <div class="container-fluid">
            <p>
                <h2 align="center">Total PARTICIPANTS till now is <?php print(mysqli_num_rows($result2)) ?></h2>
            </p>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
